        ...
        <header class="header-area clearfix">
            ...
            <nav class="amado-nav">
                <ul>
                    ...
                    <li class="active"><a href="itemList.nv">Shop</a></li>
                    <li><a href="item/ItemInfo/itemDetails.nv">Product</a></li>
            ...
            <div class="cart-fav-search mb-100">
                <a href="cart.html" class="cart-nav"><img src="../../resources/core-img/cart.png" alt=""> Cart <span>(0)</span></a>
            ...
            <div class="widget brands mb-50">
                ...
                <div class="widget-desc">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label" for="amado">Apple</label>
                    </div>
                    <!-- Single Form Check -->
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="samsung">
                        <label class="form-check-label" for="ikea">Samsung</label>
                    </div>
                    <!-- Single Form Check -->
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="lg">
                        <label class="form-check-label" for="furniture">LG</label>
                    </div>
                    <!-- Single Form Check -->
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="factory">
                        <label class="form-check-label" for="factory">-</label>
                    </div>
                    <!-- Single Form Check -->
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="" id="artdeco">
                        <label class="form-check-label" for="artdeco">-</label>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                <img src="/novusShopping/../../resources/phone/samsung/galaxy-note20-5g-black-all.webp" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/phone/samsung/galaxy-note20-5g-black-back.webp" alt="">
                                <img class="hover-img" src="../../resources/phone/samsung/galaxy-note20-5g-black-front.webp" alt="">
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    <div class="line"></div>
                                    <p class="product-price">1,199,000원</p>
                                ...
                                <div class="ratings-cart text-right">
                                 ...
                                 <!--    <div class="cart">
                                        <a href="cart.html" data-toggle="tooltip" data-placement="left" title="Add to Cart"><img src="/novusShopping/../../resourcescore-img/cart.png" alt=""></a>
                                    </div> -->
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/phone/samsung/galaxy-note20-5g-bronze-all.webp" alt="">
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/phone/samsung/galaxy-note20-5g-bronze-back.webp" alt="">
                                <img class="hover-img" src="../../resources/phone/samsung/galaxy-note20-5g-bronze-front.webp" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resources/phone/apple/iphone-12-mini-black.png" alt="">
                            </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            <!-- Product Image -->
                            <div class="product-img">
                                <img src="../../resources/phone/apple/iphone-12-mini-blue.png" alt="">
                                <!-- Hover Thumb -->
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <!-- Hover Thumb -->
                                <img class="hover-img" src="../../resource/sphone/lg/wing-back.jpg" alt="">
                            </div>
                            ...
                            <div class="product-description d-flex align-items-center justify-content-between">
                                ...
                                <div class="product-meta-data">
                                    <div class="line"></div>
                                    <p class="product-price">1,098,900원</p>
                                    <a href="product-details.html">
                                        <h6>WING</h6>
                                    </a>
                                </div>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                ...
                                <img class="hover-img" src="../../resources/phone/lg/velvet-gray-front.jpg" alt="">
                            </div>
