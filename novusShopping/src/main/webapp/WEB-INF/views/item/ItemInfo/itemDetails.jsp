                        ...
                        <div class="single_product_thumb">
                            <div id="product_details_slider" class="carousel slide" data-ride="carousel">
                                <ol class="carousel-indicators">
                                    <li class="active" data-target="#product_details_slider" data-slide-to="0" style="background-image: url(/novusShopping/resources/phone/galaxy-note20-5g-black1.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="1" style="background-image: url(/novusShopping/resources/phone/galaxy-note20-5g-black2.webp);">
                                    </li>
                                    <li data-target="#product_details_slider" data-slide-to="2" style="background-image: url(/novusShopping/resources/phone/galaxy-note20-5g-black3.webp);">
                                    </li>
                                </ol>
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        <a class="gallery_img" href="../../resources/phone/galaxy-note20-5g-black1.webp">
                                            <img class="d-block w-100" src="../../resources/phone/galaxy-note20-5g-black1.webp" alt="First slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/galaxy-note20-5g-black2.webp">
                                            <img class="d-block w-100" src="../../resources/phone/galaxy-note20-5g-black2.webp" alt="Second slide">
                                        </a>
                                    </div>
                                    <div class="carousel-item">
                                        <a class="gallery_img" href="../../resources/phone/galaxy-note20-5g-black3.webp">
                                            <img class="d-block w-100" src="../../resources/phone/galaxy-note20-5g-black3.webp" alt="Third slide">
                                        </a>
                                    </div>
                                </div>
                            </div>
